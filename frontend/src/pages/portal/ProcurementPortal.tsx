  ...
  return (
    <PortalLayout title="Procurement Dashboard">
      <div className="space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Procurement Dashboard</h2>
          <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">Purchase requests, connected to Stores inventory.</p>
        </div>
