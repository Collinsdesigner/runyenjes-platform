  ...
  return (
    <PortalLayout title="Users">
      <div className="space-y-6">
        ...
        <form onSubmit={handleCreateUser} className="bg-white border border-gray-200 rounded-lg p-5 space-y-3 dark:bg-gray-900 dark:border-gray-700">
          ...
          <table className="w-full text-sm min-w-[640px]">
            ...
            <tbody>
              ...
              {!loading && users.length === 0 && (
                <tr><td colSpan={5} className="px-4 py-6 text-center text-gray-400 dark:text-gray-500">No users found</td></tr>
              )}
              {users.map((u) => (
                <tr key={u.id} className="border-t border-gray-100 dark:border-gray-800">
                  ...
                  <td className="px-4 py-2">
                    <span className="px-2 py-0.5 rounded-full text-xs bg-gray-100 dark:bg-gray-800">{u.role}</span>
                  </td>
                  <td className="px-4 py-2">{u.status}</td>
                  <td className="px-4 py-2">
                    <div className="flex items-center gap-2">
                      <select
                        className="border border-gray-300 rounded-lg px-2 py-1 text-xs dark:border-gray-600"
