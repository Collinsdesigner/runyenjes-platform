      ...
      setPrograms(
        (programsResponse ?? []).filter(
          (program: { departmentId?: string }) =>
            !foundStudent.departmentId ||
            program.departmentId === foundStudent.departmentId
        )
      );
