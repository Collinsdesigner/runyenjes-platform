    ...
    <PortalLayout title="Assignments">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">Assignments for your registered units this term.</p>
        </div>
        ...
        {!loading && assignments.length === 0 && (
          <p className="text-sm text-gray-400 dark:text-gray-500">No assignments yet for your units.</p>
        )}
              ...
              <div key={a.id} className="bg-white border border-gray-200 rounded-lg p-4 dark:bg-gray-900 dark:border-gray-700">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 dark:text-gray-500">{a.unit.name}</p>
                ...
                {mySub?.feedback && (
                  <p className="text-xs text-green-700 mt-2 dark:text-green-300">Feedback: {mySub.feedback}</p>
                )}

                {openAssignmentId === a.id && !mySub && (
                  <div className="mt-3 border-t border-gray-100 pt-3 space-y-2 dark:border-gray-800">
                    <textarea
                    ...
                    {aiFeedback && (
                      <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 text-xs text-gray-700 whitespace-pre-wrap dark:bg-blue-950 dark:border-blue-800 dark:text-gray-300">
                        {aiFeedback}
                      </div>
                    )}
