#!/usr/bin/env python3
"""
Adds Teacher -> Assessments + Results (corrected version -- fixes an
anchor-escaping bug in the previous script that made it exit before
touching any file, so this is safe to run fresh).
"""
import os
...
#    (FIXED: \\n\\n now matches the literal backslash-n text in the
#    real file, instead of an actual Python newline)
# ------------------------------------------------------------------
